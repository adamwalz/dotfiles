...
function set-window-title {
  ...
  zstyle -s ':zenith:module:terminal:window-title' format 'title_format' || title_format="%s"
...
function set-tab-title {
  local title_format{,ted}
  zstyle -s ':zenith:module:terminal:tab-title' format 'title_format' || title_format="%s"
  zformat -f title_formatted "$title_format" "s:$argv"
...
function set-multiplexer-title {
  local title_format{,ted}
  zstyle -s ':zenith:module:terminal:multiplexer-title' format 'title_format' || title_format="%s"
  zformat -f title_formatted "$title_format" "s:$argv"
...
if zstyle -t ':zenith:module:terminal' auto-title 'always' \
  || (zstyle -t ':zenith:module:terminal' auto-title \
    && ( ! [[ -n "$STY" || -n "$TMUX" ]] ))
then
