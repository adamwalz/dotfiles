...
_comp_path="${XDG_CACHE_HOME:-$HOME/.cache}/zenith/zcompdump"
...
zstyle ':completion::complete:*' cache-path "${XDG_CACHE_HOME:-$HOME/.cache}/zenith/zcompcache"

# Case-insensitive (all), partial-word, and then substring completion.
if zstyle -t ':zenith:module:completion:*' case-sensitive; then
...
zstyle -a ':zenith:module:completion:*:hosts' etc-host-ignores '_etc_host_ignores'
