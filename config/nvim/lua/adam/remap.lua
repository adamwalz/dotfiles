...
if vim.fn.executable("lazygit") == 1 then
  vim.keymap.set("n", "<leader>gg", function() Snacks.lazygit( { cwd = utils.root.git() }) end, { desc = "Lazygit (Root Dir)" })
  ...
  vim.keymap.set("n", "<leader>gl", function() Snacks.lazygit.log({ cwd = utils.root.git() }) end, { desc = "Lazygit Log" })
...
vim.keymap.set("n", "<leader>ft", function() Snacks.terminal(nil, { cwd = utils.root() }) end, { desc = "Terminal (Root Dir)" })
vim.keymap.set("n", "<c-/>",      function() Snacks.terminal(nil, { cwd = utils.root() }) end, { desc = "Terminal (Root Dir)" })
vim.keymap.set("n", "<c-_>",      function() Snacks.terminal(nil, { cwd = utils.root() }) end, { desc = "which_key_ignore" })
