...
return {
  ...
  config = function(_, opts)
    ...
    utils.lsp.on_attach(function(client, buffer)
      require('adam.plugins.lsp_keymaps').on_attach(client, buffer)
    end)

    utils.lsp.setup()
    utils.lsp.on_dynamic_capability(require('adam.plugins.lsp_keymaps').on_attach)
    ...
    if have_mason then
      mlsp.setup {
        ensure_installed = vim.tbl_deep_extend('force', ensure_installed, utils.lazy.opts('mason-lspconfig.nvim').ensure_installed or {}),
        handlers = { setup },
      }
    end
