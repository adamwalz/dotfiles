...
local lazy_utils = require 'adam.utils.lazy'
...
local function _lsp_check_methods(client, buffer)
...
function M.setup()
  ...
  M.on_attach(_lsp_check_methods)
  M.on_dynamic_capability(_lsp_check_methods)
end
...
function M.formatter(opts)
  ...
  local ret = {
    ...
    sources = function(buf)
      local clients = M.get_clients(merge({}, filter, { bufnr = buf }))
      ---@param client vim.lsp.Client
...
function M.format(opts)
  opts = vim.tbl_deep_extend('force', {}, opts or {}, lazy_utils.opts('nvim-lspconfig').format or {}, lazy_utils.opts('conform.nvim').format or {})
